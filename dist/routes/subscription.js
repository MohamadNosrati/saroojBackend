...
import { createSubscription, getAllSubscriptions, } from "../controllers/subscription.js";
const validator = createValidator({
    passError: true,
});
const subscriptionRouter = express.Router();
subscriptionRouter.get("/", authentication, authorization(["admin"]), getAllSubscriptions);
// sliderRouter.get(
//     "/:id",
//     authentication,
//     authorization(["admin"]),
