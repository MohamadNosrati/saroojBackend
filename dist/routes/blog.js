...
import { createBlog, deleteBlog, findBlog, findBlogBySlug, getAllBlogs, getAllSlugs, updateBlog, } from "../controllers/blog.js";
...
blogRouter.post("/", authentication, authorization(["admin"]), validator.body(createBlogBodySchema), createBlog);
blogRouter.delete("/:id", authentication, authorization(["admin"]), deleteBlog);
blogRouter.patch("/:id", authentication, authorization(["admin"]), validator.body(updateBlogBodySchema), updateBlog);
