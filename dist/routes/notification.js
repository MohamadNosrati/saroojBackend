...
notificationRouter.get("/", authentication, authorization(["admin"]), getAllNotifications);
notificationRouter.post("/", authentication, authorization(["admin"]), validator.body(createNotificationBodySchema), sendNotificationToSubscriptions);
