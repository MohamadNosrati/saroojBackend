...
commentRouter.get("/:id", authentication, authorization(["admin"]), findComment);
commentRouter.post("/", validator.body(createCommentBodySchema), createComment);
commentRouter.delete("/:id", authentication, authorization(["admin"]), deleteComment);
commentRouter.patch("/:id", authentication, authorization(["admin"]), validator.body(updateCommentBodySchema), updateComment);
